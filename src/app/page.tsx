...
const homeFaqs = [
  ...
  {
    question: "ソウルやハワイなど、よく行く都市はありますか？",
    answer: "あります。ソウル、バンコク、ホノルル、ロサンゼルス、台北、シンガポールなど、出国者・在留邦人の多い都市から探せます。トップの都市一覧か、国ページから都市を開いてください。",
  },
  {
    question: "海外旅行保険はどこで確認すればいいですか？",
    answer: "受診前に保険会社の日本語デスクへ連絡し、提携病院かを確認してください。使い方の要点は海外保険ガイドにまとめています。",
  },
  {
    question: "緊急のときの連絡先は？",
...
export const metadata: Metadata = {
  title: {
    absolute: `海外で日本語が通じる病院を探す｜${totalCountries}カ国${totalCount}件 | にほんごドクター.com`,
  },
  description:
