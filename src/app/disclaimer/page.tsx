        ...
        <div className="container mx-auto px-4 py-8 max-w-4xl">
            <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-6 sm:p-10">
                ...
                <div className="prose prose-gray max-w-none prose-headings:text-gray-800 prose-p:text-gray-600 prose-li:text-gray-600">
                    ...
                    <p>
                        当サイトでは、運営継続のため Google AdSense などの第三者広告、および A8.net などのアフィリエイトリンクを表示する場合があります。
                        アフィリエイトリンク経由で商品・サービスが購入された場合、当サイトが紹介料を受け取ることがあります。
                        利用者の支払額が増えるものではありません。アフィリエイトを含むページには「PR」「広告」等の表示をします。
                        医療機関の掲載順位や選定は、広告・アフィリエイト報酬の有無とは独立しています。
                    </p>
