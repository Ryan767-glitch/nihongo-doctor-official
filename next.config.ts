...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/africa', destination: '/africa-middle-east', permanent: true },
      { source: '/africa/:path*', destination: '/africa-middle-east/:path*', permanent: true },
      { source: '/middle-east', destination: '/africa-middle-east', permanent: true },
      { source: '/middle-east/:path*', destination: '/africa-middle-east/:path*', permanent: true },
      { source: '/south-america', destination: '/latin-america', permanent: true },
